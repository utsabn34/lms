...
class gsp_lms_departmentshow_gsp extends GroovyPage {
...
printHtmlPart(13)
if(true && (departmentInstance?.description)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("department.description.label"),'default':("Description")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(departmentInstance),'field':("description")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (departmentInstance?.isActive)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("department.isActive.label"),'default':("Is Active")],-1)
printHtmlPart(19)
invokeTag('formatBoolean','g',39,['boolean':(departmentInstance?.isActive)],-1)
printHtmlPart(16)
}
printHtmlPart(17)
