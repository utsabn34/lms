		...
		<div id="list-employee" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="temporaryAddress" title="${message(code: 'employee.temporaryAddress.label', default: 'Temporary Address')}" />
				...
				<g:each in="${employeeInstanceList}" status="i" var="employeeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: employeeInstance, field: "temporaryAddress")}</td>
